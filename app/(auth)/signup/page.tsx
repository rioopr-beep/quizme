    ...
    <main className="relative min-h-screen overflow-hidden bg-[#F6F8FE]">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-5">
        <div className="w-full max-w-sm rounded-[28px] border border-white/70 bg-white/50 p-8 shadow-[0_24px_60px_-28px_rgba(30,45,120,0.28)] backdrop-blur-2xl backdrop-saturate-150">
          ...
          <h1 className="text-center text-[23px] font-extrabold text-slate-900">Buat akun</h1>
          <p className="mt-1 text-center text-[13.5px] text-slate-500">Mulai perjalanan belajarmu</p>
          ...
          <form onSubmit={handleSignup} className="flex flex-col gap-3">
            <label className="relative block">
              <span className="sr-only">Nama kamu</span>
          ...
          <p className="mt-5 text-center text-[13px] text-slate-500">
            Sudah punya akun?{' '}
            <Link href="/login" className="font-bold text-[#2955F2]">
              Masuk
            </Link>
          </p>
        </div>
