...
// ============================================================================
// QuizMe — Assessment Engine Interface
// Antarmuka eksekusi studi kasus: tombol opsi interaktif, feedback warna
// visual lembut (emerald/rose), dan panel Dossier Pembahasan.
// ============================================================================
...
export default function QuizPage(): JSX.Element {
  ...
  useEffect(() => {
    ...
    async function loadQuestions(activeSector: SectorType): Promise<void> {
  ...
  const copy = useMemo(
    () => ({
      ...
      empty:
        language === 'id'
          ? 'Belum ada soal untuk sektor ini.'
          : 'No questions available for this sector yet.',
      invalidSector: language === 'id' ? 'Sektor tidak dikenal.' : 'Unknown sector.',
