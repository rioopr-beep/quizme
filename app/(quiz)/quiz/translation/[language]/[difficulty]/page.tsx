...
export default function TranslationQuizPage(): JSX.Element {
  ...
  const engine = useQuizEngine('translation', questions);
          ...
          <div className="mt-6 flex flex-col gap-3">
            {countOptions.map((count) => (
              <button
                ...
                type="button"
                onClick={() =>
                  router.push(`/quiz/translation/${languageCode}/${difficulty}?count=${count}`)
                }
  ...
  if (questions.length === 0) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center gap-6 bg-slate-50 px-6 text-center">
        ...
        <button
          type="button"
          onClick={() => router.push(`/quiz/translation/${languageCode}`)}
      ...
      <main className="flex min-h-screen items-center justify-center bg-slate-50 px-6">
        <div className="w-full max-w-md rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50 to-white p-8 text-center shadow-sm">
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button
              type="button"
              onClick={() => router.push(`/quiz/translation/${languageCode}/${difficulty}/review`)}
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 py-10 sm:px-10">
      ...
      <ExitConfirmModal
        ...
        onConfirm={() => router.push(`/quiz/translation/${languageCode}`)}
        language={uiLanguage}
      />
    </main>
  );
