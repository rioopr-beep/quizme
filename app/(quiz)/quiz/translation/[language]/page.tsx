...
export default function TranslationModeSelectPage(): JSX.Element {
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 py-10 sm:px-10">
      <div className="mx-auto flex max-w-md flex-col gap-6">
        <button
          type="button"
          onClick={() => router.push('/quiz/translation')}
        ...
        <div className="flex flex-col gap-3">
          {MODES.map((mode) => (
            <button
              key={mode.key}
              type="button"
              onClick={() => router.push(`/quiz/translation/${params.language}/${mode.key}`)}
